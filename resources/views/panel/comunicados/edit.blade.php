    ...
    <section class="send-message-area">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <h1 class="area-heading font-w style-three">Editar comunicado</h1>
                </div>
                ...
                <div class="col-md-8 col-lg-9 col-xl-6">
                    <form action="{{ route('comunicados.update', $comunicado->id) }}" method="POST">
                        ...
                        <textarea name="mensaje" class="form-control" rows="5">{{ old('mensaje', $comunicado->mensaje) }}</textarea>

                        <button type="submit" class="btn btn-primary mt-3">Actualizar Comunicado</button>
                    </form>
