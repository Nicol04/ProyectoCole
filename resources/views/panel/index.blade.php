...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/img/panel/favicon.png') }}">
    <!-- === webfont=== -->
               ...
               <div class=" cart-area">
                    ...
                    <div class="cart-drop">
                        <div class="single-cart">
                            <div class="cart-img">
                                <img alt="" src="{{ asset('assets/img/panel/cart-1.jpg') }}">
                            </div>
                        ...
                        <div class="single-cart">
                            <div class="cart-img">
                                <img alt="" src="{{ asset('assets/img/panel/cart-2.jpg') }}">
                            </div>
                            <div class="cart-title">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-2">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ asset('assets/img/panel/logo.png') }}" alt="">
                    </a>
                </div>
            ...
            <div class="col-md-9 col-lg-9 col-xl-8">
                <div class="mainmenu float-right style-4">
                    <ul id="navigation">
                       <li class="fc-orange">
                        <img src="{{ asset('assets/img/panel/icon/menu-icon3.png') }}" alt=""><a href="index.html">Home</a>
                           <ul class="sub-menu">s
                       ...
                       <li class="fc-sky hav-sub"><img src="{{ asset('assets/img/panel/icon/menu-icon2.png') }}" alt=""><a href="#">pages<i class="fa fa-angle-down" ></i></a>
                             <div class="mega-menu">
                       ...
                       <li class="fc-red hav-sub"><img src="{{ asset('assets/img/panel/icon/menu-icon1.png') }}" alt=""><a href="#" class="font-red">Programs<i class="fa fa-angle-down" ></i></a>
                           <div class="mega-menu">
                                <div class="mega-catagory">
                                ...
                                <div class="mega-catagory mega-img">
                                    <img src="{{ asset('assets/img/panel/mega-1.jpg') }}" alt="">
                                    <span>Admission Open</span>
                                    <a href="#" class="bgc-orange">Apply now</a>
                                </div>
                            </div>
                       </li>
                       <li class="fc-green hav-sub"><img src="{{ asset('assets/img/panel/icon/menu-icon4.png') }}" alt=""><a href="facilities.html">Shortcode<i class="fa fa-angle-down" ></i></a>
                           <div class="mega-menu">
                                <div class="mega-catagory">
                                    <div class="mega-button">
                       ...
                       <li class="fc-per"><img src="{{ asset ('assets/img/panel/icon/menu-icon5.png') }}" alt=""><a href="events.html">news & events</a></li>
                       
                       <li class="fc-orange hav-sub"> <img src="{{ asset('assets/img/panel/icon/menu-icon6.png') }}" alt=""> <a href="shop.html">Shop<i class="fa fa-angle-down" ></i></a>
                          <div class="mega-menu mm-two">
                                ...
                                <div class="mega-catagory mega-img">
                                    <img src="{{ asset('assets/img/panel/product/kids-pro.jpg') }}" alt="">
                                    <span>Kids toys </span>
                                    <a href="shop.html" class="bgc-orange">Buy Now</a>
                                </div>
                            </div>
                           </li>
                       <li class="fc-sky hav-sub"><img src="{{ asset('assets/img/panel/icon/menu-icon7.png') }}" alt=""><a href="contact.html">Contact us</a></li>
                    </ul>
               </div>
            </div>
            <!--Main menu end-->
                  ...
                  <div class="row">
                     <div class="col-xl-12 slider-ext-wrap">
                        <div class="slider-text">
                         <span class="animated"><img  src="{{ asset('assets/img/panel/icon/slider-text.png') }}" alt=""></span>
   ...
   <!--Class area start-->
                            ...
                            <div class="teacher-detail">
                                ...
                                <div class="teacher-social">
                                    <ul>
                                        ...
                                        <li><a class="linked" href="#"><i class="fa fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                            </div>
    ...
    <section class="kids-care-routine-area style-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <h2 class="area-heading font-per st-two">Class Routine<img src="{{ asset('assets/img/panel/icon/pen-per.png') }}" alt=""></h2>
                    <p class="area-subline">Lorem ipsum dolor sit amet, consectetur Excepteur sint occaecat cupidatat non proident, sunt in cuculpa qui officiacuculpa qui officiacuculpa qui officiaLorem ipsum dolor sit amet,cuculpa qui officiacuculpa.</p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div id="accordion" role="tablist">
                        <div class="card">
                            <div class="card-header" role="tab" id="headingEight">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" href="#collapseEight" aria-expanded="true" aria-controls="collapseEight">Saturday </a>
                                </h5>
                            </div>
                            ...
                            <div id="collapseEight" class="collapse " role="tabpanel" data-parent="#accordion">
                                <div class="card-body row no-gutters">
                                    ...
                                    <div class="row no-gutters">
                                            <div class="col-sm-6"><div class="sin-sub bg-per">8.00 am - 9.00 am</div></div>
                                            <div class="col-sm-6"><div class="sin-sub bg-per">Mathmetics</div></div>
                                    </div>
                                    <div class="row no-gutters">
                                            <div class="col-sm-6"><div class="sin-sub bg-orange">9.00 am - 10.00 am</div></div>
                                            <div class="col-sm-6"><div class="sin-sub bg-orange">Art class</div></div>
                                    </div>
                                        <div class="row no-gutters">
                                            <div class="col-sm-6"><div class="sin-sub bg-green">10.00 am - 11.00 am</div></div>
                                            <div class="col-sm-6"><div class="sin-sub bg-green">Geography</div></div>
                                    </div>
                                    <div class="row no-gutters">
                                            <div class="col-sm-6"><div class="sin-sub bg-brick">11.00 am - 12.00 am</div></div>
                                            <div class="col-sm-6"><div class="sin-sub bg-brick">Mathmetics</div></div>
                                    </div>
                                        <div class="row no-gutters">
                                            <div class="col-sm-6"><div class="sin-sub bg-per">12.00 am - 1.00 pm</div></div>
                                            <div class="col-sm-6"><div class="sin-sub bg-per">Social awarness</div></div>
                                       </div>
                                       <div class="row no-gutters">
                                            <div class="col-sm-6"><div class="sin-sub bg-orange">1.00 pm - 2.00 pm</div></div>
                                            <div class="col-sm-6"><div class="sin-sub bg-orange">Basic skills</div></div>
                                       </div>
                                       <div class="row no-gutters">
                                            <div class="col-sm-6"><div class="sin-sub bg-green">2.00 pm - 3.00 pm</div></div>
                                            <div class="col-sm-6"><div class="sin-sub bg-green">Mathmetics</div></div>
                                       </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTen" class="collapse" role="tabpanel" aria-labelledby="headingFive" data-parent="#accordion">
                                <div class="card-body row no-gutters">
                       ...
                       <!--Single popular testimonial-->
                        <div class="col-xl-12 item">
                            <div class="sin-pop-tes color-per">
                                ...
                                <div class="img-part">
                                    <div class="pt-img">
                                        <img src="img/icon/tes-c3.png" alt="">
                                    </div>
                                    <div class="pt-intro">
                ...
                <div class="row filtr-container">
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="1">
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-1.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                                <h4>School</h4>
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="2" >
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-2.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                                <h4>Kindergarten</h4>
                                <p>By: kidzcare Theme</p>
                            </div>
                        </div>
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="3">
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-3.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="1">
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-4.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                                <h4>School</h4>
                                <p>By: kidzcare Theme</p>
                            </div>
                        </div>
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="2">
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-5.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                                <h4>Kindergarten</h4>
                                <p>By: kidzcare Theme</p>
                            </div>
                        </div>
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="3">
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-6.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                                <h4>Picnics Gallery</h4>
                                <p>By: kidzcare Theme</p>
                            </div>
                        </div>
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="1">
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-7.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                                <h4>School</h4>
                                <p>By: kidzcare Theme</p>
                            </div>
                        </div>
                    ...
                    <div class=" col-sm-6 col-md-4 col-lg-3 col-xl-3 filtr-item"  data-category="2">
                        <div class="sin-gallery">
                            ...
                            <div class="gallery-content">
                                <a href="{{ asset('assets/img/panel/gallery/gal-8.jpg') }}" class="venobox vbox-item" data-gall="gallery1"><i class="fa fa-search"></i></a>
                                <h4>Kindergarten</h4>
                                <p>By: kidzcare Theme</p>
                            </div>
                        </div>
                    ...
                    <div class="ln3-cont">
                        ...
                        <div class="aut-date">
                           <a href=""><span><i class="fa fa-user"></i>Jone Doe</span></a>
                            <a href=""><span><i class="fa fa-calendar" aria-hidden="true"></i>March 21</span></a>
                        </div>
                        <p>Lorem ipsum dolor sit consectetur Excepteur sint occaecat cupidatat non proident, sunt in cuculpa qui officiacuculpa</p>
           ...
           <div class="col-sm-6 col-lg-3">
               <div class="single-widget">
                    ...
                    <div class="footer-contact">
                        <div class="sin-con">
                            <img src="{{ asset('assets/img/panel/icon/marker-3.png') }}" alt="">
                            <p>4318 Mansion House, Greenland United States</p>
                        </div>
                        <div class="sin-con">
                           <img src="{{ asset('assets/img/panel/icon/phone-i3.png') }}" alt="">
                            <a href="">(000) 233 - 3236</a>
                        </div>
                        <div class="sin-con">
                            <img src="{{ asset('assets/img/panel/icon/envelope-i3.png') }}" alt="">
